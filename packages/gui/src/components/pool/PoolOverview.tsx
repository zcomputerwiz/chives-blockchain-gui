...
import { Flex, UnitFormat, More, Table, mojoToChivesLocaleString, Suspender } from '@chives/core';
...
import { WalletStatus } from '@chives/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToChivesLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
