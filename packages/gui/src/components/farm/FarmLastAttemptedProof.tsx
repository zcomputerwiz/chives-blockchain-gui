...
import { Link, Loading, Table, Card, FormatBytes } from '@chives/core';
import { useGetFarmingInfoQuery } from '@chives/api-react';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/HiveProject2021/chives-light-wallet/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
