...
If you want to learn more about this project, read the [wiki](https://github.com/HiveProject2021/chives-light-wallet/wiki), or check out the [green paper](https://www.chives.net/assets/ChivesGreenPaper.pdf).
