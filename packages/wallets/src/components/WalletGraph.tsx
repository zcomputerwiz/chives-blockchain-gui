...
import { TransactionType } from '@chives/api';
import type { Transaction } from '@chives/api';
import { mojoToChives, blockHeightToTimestamp } from '@chives/core';
  ...
  const points = [
    {
      ...
      y: Math.max(0, Number(mojoToChives(start))),
      tooltip: mojoToChives(balance),
    },
  ];
